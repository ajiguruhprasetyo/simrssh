...
<?php $__env->startSection('content'); ?>
	...
	<?php echo Form::open(array('route' => 'complaint.store','method'=>'POST')); ?>
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-12 col-md-12">
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                <?php echo Form::number('no_hp', null, array('placeholder' => '08XXXXXXXX','class' => 'form-control')); ?>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                <?php echo Form::date('tanggal', null, array('placeholder' => 'xx/xx/xxxx','class' => 'form-control')); ?>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                <?php echo Form::date('tgl_feedback', null, array('placeholder' => 'xx/xx/xxxx','class' => 'form-control')); ?>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                <?php echo Form::textarea('feedback', null, array('placeholder' => 'Tanggapan dari rumah sakit...','class' => 'form-control','style'=>'height:100px')); ?>
