<?php $__env->startSection('content'); ?>
	...
	<div class="box box-primary">
			...
			<div class="box-body">
				...
				<br>
				<?php echo Form::model($unit_kerja, ['method' => 'PATCH','route' => ['unit_kerja.update', $unit_kerja->id]]); ?>

				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12">
						<div class="form-group">
							<strong>Unit Kerja :</strong>
							<?php echo Form::text('unit_kerja', null, array('placeholder' => 'Nama','class' => 'form-control')); ?>
