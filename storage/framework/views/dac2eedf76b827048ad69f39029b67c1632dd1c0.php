	...
	<div class="row">
	    ...
	    <div class="col-lg-12 margin-tb">
	        ...
	        <div class="pull-right">
	            ...
	            <a class="btn btn-sm btn-success" href="<?php echo e(route('users.create')); ?>"> Create New User</a>
				<a class="btn btn-sm btn-default" href="<?php echo e(route('users.download')); ?>"> Download</a>
