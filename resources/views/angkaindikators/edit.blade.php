...
@section('content')
    ...
    <div class="box box-primary">
		...
		<div class="box-body">
			...
			<br>
            {!! Form::model($ais, ['method'=>'PATCH', 'route' => ['angkaindikator.update', $ais->id], 'name' => 'autoSumForm']) !!}
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::date('tgl_input', null, array('placeholder' => '','class' => 'form-control')) !!}
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::number('angka_persentase', null, array('placeholder' => '','class' => 'form-control', 'onFocus' => 'startPercent();', 'onBlur' => 'stopPercent();')) !!}
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::number('jumlah', null, array('placeholder' => '','class' => 'form-control', 'onFocus' => 'startPercent();', 'onBlur' => 'stopPercent();')) !!}
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('persentase', null, array('placeholder' => '{{ jumlah * angka_persentase }}','class' => 'form-control', 'value' => '0', 'readonly')) !!}
                    </div>
                </div>
