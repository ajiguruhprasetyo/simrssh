    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                {!! Form::text('alamat', null, array('placeholder' => ' ','class' => 'form-control')) !!}
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                <strong>Tanggal Feedback :</strong>
                 ...
                 {!! Form::date('tgl_feedback', null, array('placeholder' => '','class' => 'form-control')) !!}
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                {!! Form::textarea('feedback', null, array('placeholder' => ' ','class' => 'form-control','style'=>'height:100px')) !!}
