	...
	<div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
         ...
         <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                {!! Form::date('tgl_feedback', null, array('placeholder' => 'xx/xx/xxxx','class' => 'form-control')) !!}
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                {!! Form::textarea('feedback', null, array('placeholder' => 'Tanggapan dari rumah sakit...','class' => 'form-control','style'=>'height:100px')) !!}
