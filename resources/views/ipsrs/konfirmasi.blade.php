						...
						<tbody>
							<tr>
								...
								<td>
									...
									@permission('update-ipsrs')
										<a class="btn btn-sm btn-primary" href="{{ route('ipsrs.edit',$p->id) }}"><i class="fa fa-edit"></i></a>
									@endpermission

									@permission('delete-ipsrs')
